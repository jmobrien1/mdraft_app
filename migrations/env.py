"""
Alembic environment configuration for mdraft.

This file configures Alembic to work with the Flask-SQLAlchemy setup
and provides access to the application's models for automatic
